...
x = np.linspace(start=sample_mean - 4*sample_std_dev, stop=sample_mean + 4*sample_std_dev, num=1000)
...
# Hint: Remember the functions described in the examples, choose an appropriate range for x
exp_x = np.linspace(start=0, stop=max(exponential_samples)*2, num=1000)
